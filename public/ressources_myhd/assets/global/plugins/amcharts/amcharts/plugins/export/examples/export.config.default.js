...
AmCharts.exportPDF = {
	"format": "PDF",
	"content": [ "Sauvé de la:", window.location.href, {
		"image": "reference",
...
AmCharts.exportCFG = {
	"enabled": true,
	"libs": {
		"path": "ressources_bo_wtp/assets/global/plugins/amcharts/amcharts/plugins/export/libs/"
	},
	"menu": [ {
		"class": "export-main",
		"label": "Export",
		"menu": [ {
			"label": "Téléchargez en ...",
			"menu": [ "PNG", "JPG", "SVG", AmCharts.exportPDF ]
		}, {
			"label": "Sauvegarder en ...",
			"menu": [ "CSV", "XLSX", "JSON" ]
		}, {
			"label": "Annoter ...",
			"action": "draw",
